package ru.smwed.composepickers.datetime.date
...
interface DatePickerColors {
    ...
    @Composable
    fun dateBorderColor(isToday: Boolean): State<Color>
}
...
internal class DefaultDatePickerColors(
    ...
    @Composable
    override fun dateBorderColor(isToday: Boolean): State<Color> {
        return rememberUpdatedState(if (isToday) dateActiveBackgroundColor else dateInactiveBackgroundColor)
    }
}
